package com.frank.spring.eureka.server.util;
...
public class RequestHelper {
    ...
    public static ResponseEntity<?> formatSuccessResult(Object data) {
        return formatSuccessResult(data, SerializerFeature.WriteMapNullValue, SerializerFeature.WriteNullNumberAsZero);
    }
